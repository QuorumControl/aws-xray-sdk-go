...
```
go get -u github.com/quorumcontrol/aws-xray-sdk-go/...
```

If you also want to install SDK's testing dependencies. They can be installed using:

```
go get -u -t github.com/quorumcontrol/aws-xray-sdk-go/...
```
...
* If you think you may have found a bug, please open an [issue](https://github.com/quorumcontrol/aws-xray-sdk-go/issues/new).

## Opening Issues

If you encounter a bug with the AWS X-Ray SDK for Go we would like to hear about it. Search the [existing issues](https://github.com/quorumcontrol/aws-xray-sdk-go/issues) and see if others are also experiencing the issue before opening a new issue. Please include the version of AWS X-Ray SDK for Go, AWS SDK for Go, Go language, and OS you’re using. Please also include repro case when appropriate.

The GitHub issues are intended for bug reports and feature requests. For help and questions with using AWS SDK for Go please make use of the resources listed in the [Getting Help](https://github.com/quorumcontrol/aws-xray-sdk-go#getting-help) section. Keeping the list of open issues lean will help us respond in a timely manner.
...
import (
  ...
  "github.com/quorumcontrol/aws-xray-sdk-go/xray"

  // Importing the plugins enables collection of AWS resource information at runtime
  _ "github.com/quorumcontrol/aws-xray-sdk-go/plugins/ec2"
  _ "github.com/quorumcontrol/aws-xray-sdk-go/plugins/beanstalk"
  _ "github.com/quorumcontrol/aws-xray-sdk-go/plugins/ecs"
)
